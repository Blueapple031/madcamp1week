...
public class BuildingRepository {
    ...
    private void initializeBuildings() {
        ...
        buildings.add(new Building("장영신 학생회관", new LatLng(36.3733, 127.3605), "퀴즈노스", R.drawable.jangyungsin));
        ...
        buildings.add(new Building("정문술 빌딩", new LatLng(36.3712, 127.3623), "서브웨이", R.drawable.jungmun_building));
        buildings.add(new Building("매점 건물", new LatLng(36.3741, 127.3598), "풀빛마루, 매점", R.drawable.maejum));
